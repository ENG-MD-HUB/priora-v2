              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    opacity: valid ? 1 : 0.55, overflow: 'hidden',
                  }}
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '9px 12px' }}>
                    <button
                      onClick={() => toggleDeletedFolderExpanded(folder.id)}
                      style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: 18, height: 18, flexShrink: 0, background: 'none', border: 'none', cursor: folderTasks.length > 0 ? 'pointer' : 'default', color: 'var(--text3)', padding: 0 }}
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      <div style={{ fontSize: 11, color: 'var(--text3)' }}>{folderTasks.length} task{folderTasks.length === 1 ? '' : 's'} inside · {getTimeLeftLabel(folder._deletedAt)}</div>
                    </div>
                    {valid && (
                      <button
                  ...
                  {isExpanded && folderTasks.length > 0 && (
                    <div style={{ borderTop: '1px solid var(--border)', background: 'var(--surface2)', padding: '6px 12px 8px 50px' }}>
